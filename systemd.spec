...
Source0  : https://github.com/systemd/systemd/archive/v246.tar.gz
...
%prep
%setup -q -n systemd-246
cd %{_builddir}/systemd-246
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598039299
...
cp %{_builddir}/systemd-246/LICENSE.GPL2 %{buildroot}/usr/share/package-licenses/systemd/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/systemd-246/LICENSE.LGPL2.1 %{buildroot}/usr/share/package-licenses/systemd/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/systemd-246/tools/chromiumos/LICENSE %{buildroot}/usr/share/package-licenses/systemd/5aebbff6ecbe1754fc59dc9b27e1ea8692384d64
pushd ../build32/
...
/usr/lib64/libsystemd.so.0.29.0
/usr/lib64/libudev.so.1
/usr/lib64/libudev.so.1.6.18
...
/usr/lib32/libsystemd.so.0.29.0
/usr/lib32/libudev.so.1
/usr/lib32/libudev.so.1.6.18
