...
%prep
%setup -q -n systemd-stable-251.5
cd %{_builddir}/systemd-stable-251.5
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
%patch38 -p1
pushd ..
cp -a systemd-stable-251.5 build32
popd
...
-Dsbat-distro-url=https://clearlinux.org/  builddir
ninja -v -C builddir
pushd ../build32/
...
-Dsbat-distro=clearlinux \
-Dsbat-distro-summary="Clear Linux OS for Intel (R) Architecture" \
-Dsbat-distro-url=https://clearlinux.org/ -Dlibcryptsetup=false \
-Dgnutls=false \
-Dlibcurl=false \
-Delfutils=false \
-Dmicrohttpd=false \
