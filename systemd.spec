...
Version  : 255.5
Release  : 377
URL      : https://github.com/systemd/systemd-stable/archive/v255.5/systemd-stable-255.5.tar.gz
Source0  : https://github.com/systemd/systemd-stable/archive/v255.5/systemd-stable-255.5.tar.gz
...
%prep
%setup -q -n systemd-stable-255.5
cd %{_builddir}/systemd-stable-255.5
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
%patch -P 30 -p1
pushd ..
cp -a systemd-stable-255.5 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714080502
