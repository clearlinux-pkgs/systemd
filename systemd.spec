...
Version  : 249.1
Release  : 286
URL      : https://github.com/systemd/systemd-stable/archive/v249.1.tar.gz
Source0  : https://github.com/systemd/systemd-stable/archive/v249.1.tar.gz
...
Patch41: 0041-Disable-LLDP-listening-by-default.patch
Patch42: 0042-units-use-var-swapfile-if-found.patch
...
%prep
%setup -q -n systemd-stable-249.1
cd %{_builddir}/systemd-stable-249.1
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
%patch42 -p1
pushd ..
cp -a systemd-stable-249.1 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627024440
...
cp %{_builddir}/systemd-stable-249.1/LICENSE.GPL2 %{buildroot}/usr/share/package-licenses/systemd/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/systemd-stable-249.1/LICENSE.LGPL2.1 %{buildroot}/usr/share/package-licenses/systemd/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/systemd-stable-249.1/tools/chromiumos/LICENSE %{buildroot}/usr/share/package-licenses/systemd/5aebbff6ecbe1754fc59dc9b27e1ea8692384d64
pushd ../build32/
...
/usr/lib32/libsystemd.so.0.32.0
/usr/lib32/libudev.so.1
/usr/lib32/libudev.so.1.7.2
