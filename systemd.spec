...
Patch46: 0046-meson-do-not-fail-if-rsync-is-not-installed-with-mes.patch
...
%prep
%setup -q -n systemd-stable-246.4
cd %{_builddir}/systemd-stable-246.4
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619222042
...
cp %{_builddir}/systemd-stable-246.4/LICENSE.GPL2 %{buildroot}/usr/share/package-licenses/systemd/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/systemd-stable-246.4/LICENSE.LGPL2.1 %{buildroot}/usr/share/package-licenses/systemd/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/systemd-stable-246.4/tools/chromiumos/LICENSE %{buildroot}/usr/share/package-licenses/systemd/5aebbff6ecbe1754fc59dc9b27e1ea8692384d64
pushd ../build32/
