...
%package extras-libsystemd
Summary: extras-libsystemd components for the systemd package.
Group: Default

%description extras-libsystemd
extras-libsystemd components for the systemd package.
...
Requires: systemd-data = %{version}-%{release}
Requires: systemd-license = %{version}-%{release}
Requires: systemd-extras-libsystemd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743199623
