...
Version  : 251.11
Release  : 308
URL      : https://github.com/systemd/systemd-stable/archive/v251.11/systemd-stable-251.11.tar.gz
Source0  : https://github.com/systemd/systemd-stable/archive/v251.11/systemd-stable-251.11.tar.gz
...
Patch10: 0010-mount-setup-mount-kernel-fs-by-default.patch
Patch11: 0011-Ship-default-services-in-system-unit-dir.patch
Patch12: 0012-bootctl-Add-force-option-to-enable-chroot-install-re.patch
Patch13: 0013-tmpfiles-Make-var-cache-ldconfig-world-readable.patch
Patch14: 0014-Set-a-default-unique-hostname-when-it-is-either-clr-.patch
Patch15: 0015-more-udev-children-workers.patch
Patch16: 0016-not-load-iptables.patch
Patch17: 0017-Add-journal-flush-service-for-Microsoft-Azure-VMs.patch
Patch18: 0018-Enable-BBR-Bottleneck-Bandwidth-and-RTT.patch
Patch19: 0019-network-online-complete-once-one-link-is-online-not-.patch
Patch20: 0020-DHCP-retry-faster.patch
Patch21: 0021-Remove-libm-memory-overhead.patch
Patch22: 0022-skip-not-present-ACPI-devices.patch
Patch23: 0023-Ensure-var-run-is-never-a-directory.patch
Patch24: 0024-Make-timesyncd-a-simple-service.patch
Patch25: 0025-Compile-udev-with-O3.patch
Patch26: 0026-Don-t-wait-for-utmp-at-shutdown.patch
Patch27: 0027-Don-t-do-transient-hostnames-we-set-ours-already.patch
Patch28: 0028-don-t-use-libm-just-for-integer-exp10.patch
Patch29: 0029-Notify-systemd-earlier-that-resolved-is-ready.patch
Patch30: 0030-Hand-off-coredumps-to-a-wrapper-that-will-optionally.patch
Patch31: 0031-add-stateless-for-locale-files-locale.conf-00-keyboa.patch
Patch32: 0032-Do-not-enable-audit-by-default-in-the-journal.patch
Patch33: 0033-Disable-XZ-support-in-the-journal.patch
Patch34: 0034-Localize-1-symbol.patch
Patch35: 0035-mount-setup-Harden-a-bit-the-options-for-certan-moun.patch
Patch36: 0036-Disable-LLDP-listening-by-default.patch
Patch37: 0037-units-use-var-swapfile-if-found.patch
Patch38: binutils-fix.patch
...
%prep
%setup -q -n systemd-stable-251.11
cd %{_builddir}/systemd-stable-251.11
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
%patch38 -p1
pushd ..
cp -a systemd-stable-251.11 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675094491
...
/usr/lib64/libsystemd.so.0.34.0
/usr/lib64/libudev.so.1
/usr/lib64/libudev.so.1.7.4
...
/usr/lib32/libsystemd.so.0.34.0
/usr/lib32/libudev.so.1
/usr/lib32/libudev.so.1.7.4
