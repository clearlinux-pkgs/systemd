...
%prep
%setup -q -n systemd-245
cd %{_builddir}/systemd-245
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
cp %{_builddir}/systemd-245/LICENSE.GPL2 %{buildroot}/usr/share/package-licenses/systemd/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/systemd-245/LICENSE.LGPL2.1 %{buildroot}/usr/share/package-licenses/systemd/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/systemd-245/tools/chromiumos/LICENSE %{buildroot}/usr/share/package-licenses/systemd/5aebbff6ecbe1754fc59dc9b27e1ea8692384d64
pushd ../build32/
...
/usr/lib64/libsystemd.so.0.28.0
/usr/lib64/libudev.so.1
/usr/lib64/libudev.so.1.6.17
