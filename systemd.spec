...
Patch14: 0015-more-udev-children-workers.patch
Patch15: 0016-not-load-iptables.patch
Patch16: 0017-Add-journal-flush-service-for-Microsoft-Azure-VMs.patch
Patch17: 0018-Enable-BBR-Bottleneck-Bandwidth-and-RTT.patch
Patch18: 0019-network-online-complete-once-one-link-is-online-not-.patch
Patch19: 0020-DHCP-retry-faster.patch
Patch20: 0021-Remove-libm-memory-overhead.patch
Patch21: 0022-skip-not-present-ACPI-devices.patch
Patch22: 0023-Ensure-var-run-is-never-a-directory.patch
Patch23: 0024-Make-timesyncd-a-simple-service.patch
Patch24: 0025-Compile-udev-with-O3.patch
Patch25: 0026-Don-t-wait-for-utmp-at-shutdown.patch
Patch26: 0027-Don-t-do-transient-hostnames-we-set-ours-already.patch
Patch27: 0028-don-t-use-libm-just-for-integer-exp10.patch
Patch28: 0029-Notify-systemd-earlier-that-resolved-is-ready.patch
Patch29: 0030-Hand-off-coredumps-to-a-wrapper-that-will-optionally.patch
Patch30: 0032-Do-not-enable-audit-by-default-in-the-journal.patch
Patch31: 0033-Disable-XZ-support-in-the-journal.patch
Patch32: 0034-Localize-1-symbol.patch
Patch33: 0035-mount-setup-Harden-a-bit-the-options-for-certan-moun.patch
Patch34: 0036-Disable-LLDP-listening-by-default.patch
Patch35: 0037-units-use-var-swapfile-if-found.patch
Patch36: binutils-fix.patch
...
%prep
%setup -q -n systemd-stable-252.5
cd %{_builddir}/systemd-stable-252.5
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
%patch36 -p1
pushd ..
cp -a systemd-stable-252.5 build32
popd
...
/usr/lib32/libsystemd.so.0.35.0
/usr/lib32/libudev.so.1
/usr/lib32/libudev.so.1.7.5
/usr/lib32/security/pam_systemd.so
/usr/lib32/systemd/libsystemd-core-252.so
/usr/lib32/systemd/libsystemd-shared-252.so
...
/usr/share/man/man8/systemd-pcrphase.8
