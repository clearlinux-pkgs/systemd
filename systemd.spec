...
Source0  : https://github.com/systemd/systemd/archive/v244.tar.gz
...
%prep
%setup -q -n systemd-244
cd %{_builddir}/systemd-244
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576268000
...
cp %{_builddir}/systemd-244/LICENSE.GPL2 %{buildroot}/usr/share/package-licenses/systemd/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/systemd-244/LICENSE.LGPL2.1 %{buildroot}/usr/share/package-licenses/systemd/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/systemd-244/tools/chromiumos/LICENSE %{buildroot}/usr/share/package-licenses/systemd/5aebbff6ecbe1754fc59dc9b27e1ea8692384d64
pushd ../build32
...
/usr/lib/udev/rules.d/60-autosuspend-chromiumos.rules
...
/usr/lib/udev/rules.d/61-autosuspend-manual.rules
...
/usr/lib64/libsystemd.so.0.27.1
/usr/lib64/libudev.so.1
/usr/lib64/libudev.so.1.6.16
...
/usr/lib32/libsystemd.so.0.27.1
/usr/lib32/libudev.so.1
/usr/lib32/libudev.so.1.6.16
