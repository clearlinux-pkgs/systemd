...
Version  : 251.6
Release  : 302
URL      : https://github.com/systemd/systemd-stable/archive/v251.6/systemd-stable-251.6.tar.gz
Source0  : https://github.com/systemd/systemd-stable/archive/v251.6/systemd-stable-251.6.tar.gz
...
%prep
%setup -q -n systemd-stable-251.6
cd %{_builddir}/systemd-stable-251.6
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
%patch38 -p1
pushd ..
cp -a systemd-stable-251.6 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665782622
